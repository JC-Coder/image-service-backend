...
export class ImagesController {
  ...
  @UseGuards(JwtAuthGuard)
  async getPrivateImage(@Res() res: Response, @Param('privatePath') privatePath: string) {
    try {
  ...
  // get image by public path
  @Get('public/:publicPath')
  async getPublicImage(@Res() res: Response, @Param('publicPath') publicPath: string) {
    try {
      let image = await this.imagesService.getPublicImage(publicPath);
